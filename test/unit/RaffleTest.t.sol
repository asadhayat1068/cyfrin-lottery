...
contract RaffleTest is Test, CodeConstants {
    ...
    function testPerformUpkeepRevertsIfCheckUpKeepIsFalse() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                Raffle.Raffle__UpkeepNotNeeded.selector, currentBalance, playerCount, uint256(raffleState)
            )
        );
        raffle.performUpkeep("");
    }
    ...
    function testFullFullRandomWordsCanOnlyBeCalledByPerformUpKeep(uint256 randomRequestId)
        public
        raffleEntered
        skipFork
    {
